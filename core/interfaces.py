...
class ToolDefinition(BaseModel):
    ...
    output_schema: Optional[Dict[str, Any]] = Field(
        ...
        description=(
            ...
            "Only set this for tools that populate structured_content on "
            "EVERY path, including zero-result ones."
        ),
    )
...
class ToolResult(BaseModel):
    ...
    structured_content: Optional[Any] = Field(
        ...
        description=(
            ...
            "`content` is still sent alongside it, so clients that ignore "
